...
def oddeven(request, number):
    ...
    return render(request, "practices/oddeven.html", context)
...
def dormitory(request):
    ...
    return render(request, "practices/dormitory.html")
...
def dormitory_s(request):
    ...
    return render(request, "practices/dormitory_s.html", context)


def lorem_kor(request):

    return render(request, "practices/lorem_kor.html")
...
def lorem_kor_result(request):
    ...
    return render(request, "practices/lorem_kor_result.html", context)
