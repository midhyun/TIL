...
```python
dir = Director.objects.values().get(name = '봉준호')
...
```python
dic_ = Genre.objects.values().get(title = '드라마')
...
movie = Movie.objects.filter(director = dir).order_by('opening_date')
for i in movie:
    print(
    i.director.name ,
    i.genre.title ,
...
```python
dir = Director.objects.get(name = '봉준호')
movie = Movie.objects.filter(director = dir).order_by('opening_date')[1]
for i in [movie]:
    print(
    i.director.name ,
    i.genre.title ,
...
movie = Movie.objects.filter(director = dir, genre = gen).order_by('opening_date')
for i in movie:
    print(
    i.director.name ,
    i.genre.title ,
...
```python
dir = Director.objects.get(name = '봉준호')
movie = Movie.objects.exclude(director = dir).order_by('opening_date')
for i in movie:
    print(
    i.director.name ,
    i.genre.title ,
